...
const About = () => {
  ...
  return (
    <section id="about" className="bg-gradient-to-b from-[#030303] via-[#0d0404] to-[#030303] pt-28 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans border-t border-gray-950">
      
      {/* Background radial highlight */}
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-red-950/10 blur-[150px] pointer-events-none" />
